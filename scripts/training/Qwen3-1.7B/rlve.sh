...
export WANDB_API_KEY=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
unset https_proxy
unset http_proxy
...
CKPT_ARGS=(
   --hf-checkpoint /inspire/hdd/global_user/xucaijun-253108120121/Model/Qwen/Qwen3-1.7B-Base
   --ref-load ../Qwen3-1.7B_torch_dist
   --load ../${RUN_NAME}-2/
   --save ../${RUN_NAME}-2/
   --save-interval 500
)
